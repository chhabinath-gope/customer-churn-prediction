...
.result-card.low-result {

    border-color: #22c55e;

    box-shadow:
        0 20px 55px rgba(34,197,94,.20);
...
.result-card.medium-result {

    border-color: #f59e0b;

    box-shadow:
        0 20px 55px rgba(245,158,11,.28);
...
.result-card.high-result {

    border-color: #ef4444;

    box-shadow:
        0 20px 55px rgba(239,68,68,.35);
...
.result-card.critical-result {

    border-color: #dc2626;

    box-shadow:
        0 0 20px rgba(220,38,38,.45),
        0 20px 70px rgba(220,38,38,.40);

    animation:
        dangerPulse 2s ease-in-out infinite;
...
@keyframes dangerPulse {
    ...
    100% {
        ...
        box-shadow:
            0 0 15px rgba(220,38,38,.35),
            0 20px 60px rgba(220,38,38,.25);
    ...
    50% {
        ...
        box-shadow:
            0 0 35px rgba(220,38,38,.70),
            0 20px 80px rgba(220,38,38,.45);
...
.critical-color {
    ...
    text-shadow:
        0 0 12px rgba(185,28,28,.45);

    animation:
        dangerText 1.4s ease-in-out infinite;
...
/* ============================================================
   EXTRA MOBILE RESULT IMPROVEMENT
============================================================ */
...
def predict():
    ...
    if probability_value >= 0.80:

        risk = "Critical Risk"

        risk_class = "critical"

        result_class = "critical-result"

        probability_class = "critical-color"
        ...
        recommendation = (
            ...
            "This customer shows a very high estimated "
            "churn probability. Immediate retention "
            "action is recommended, such as a personalized "
            "offer, dedicated support or a contract incentive."
        ...
        recommendation = (
            ...
            "This customer has a high estimated churn "
            "risk. Consider a personalized retention "
            "offer, service support or a long-term "
            "contract incentive."
        ...
        result_class = "medium-result"

        probability_class = "medium-color"
...
<div class="card result-card {{ result_class }}">
...
<div
class="prediction {{ probability_class }}"
>
{{ result }}
</div>
...
<div
class="probability probability-number {{ probability_class }}"
...
""",
        ...
        probability_glow=probability_glow,
